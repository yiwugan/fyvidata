...
mapping *day_phase = ({
        ([      "start_at"      :       0,
                "event_msg"     :       BLU"你似乎听到三更的梆鼓声。"NOR,
                "desc_msg"      :       BLU"夜幕低垂，四周一片暗灰"NOR,
        ]),
        ([      "start_at"      :       240,
                "event_msg"     :       WHT"东方的天空中逐渐出现了一丝鱼肚白。"NOR,
                "desc_msg"      :       WHT"东方的天空浮着一丝淡白色"NOR,
        ]),
        
        ([      "start_at"      :       360,
                "event_msg"     :       RED"东方的天空越来越亮，渐渐出现红色。"NOR,
                "desc_msg"      :       RED"红霞在东方的地平线上浮动"NOR,
        ]),
        ([      "start_at"      :       480,
                "event_msg"     :       HIW"天光似乎越来越垂直了。"NOR,
                "desc_msg"      :       HIW"百鸟开始此起彼伏地啼鸣，已经到上午了"NOR,
        ]),
        ([      "start_at"      :       660,
                "event_msg"     :       YEL"气温逐渐增高，似乎已经是正午了。"NOR,
                "desc_msg"      :       YEL"正午到了，忙碌的世界似乎安静了一些"NOR,
        ]),
        ([      "start_at"      :       900,
                "event_msg"     :       HIC"光线开始慢慢地偏西。"NOR,
                "desc_msg"      :       HIC"树荫似乎开始偏往东方了"NOR,
        ]),
        ([      "start_at"      :       1080,
                "event_msg"     :       RED"晚霞将西方的天空映成一片火红。"NOR,
                "desc_msg"      :       RED"一带红红的云霞正徘徊在西方的地平线上"NOR,
        ]),
        ([      "start_at"      :       1260,
                "event_msg"     :       WHT"苍白的大地终于完全吞没了最后一丝光亮。"NOR,
                "desc_msg"      :       WHT"夜幕笼罩，周围渐渐隐入了黑暗中"NOR,
        ])
}); 
mapping *year_phase = ({
        ([      "month"         :       1,
