...
坑坑洼洼，道旁静静立的是三三两两的老槐树，远处那连绵不断的山峦便是东
岳泰山了。路旁的半人多高的杂草丛里似乎隐约有个石碑。 
LONG
  );
  set("exits",([
         "southwest":__DIR__"road1",
  "northeast" : AREA_QINGPING"road",
               ]));
        set("item_desc", ([
                "shibei" : (: bei :),
                "石碑" : (: bei :),
...
string bei(){
        ...
        if(!query("cleaned")) {
          ...
          if(me->query("class") == "official" && me->query_skill("yue-spear") != 0 && me->query("marks/大名湖畔纵横天下") == 1){
...
void do_spear(object me){
        ...
        if(me->query_skill("yue-spear",1) >= 120 && me->query("combat_exp")>2700000){
