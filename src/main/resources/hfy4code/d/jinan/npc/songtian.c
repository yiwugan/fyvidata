...
void greeting(object me)
{
        ...
        {
                message_vision(CYN"宋甜儿白了你一眼，说道：“唔使急，仲要再等一阵。。 \n"NOR,me);
...
int ask_for()
{
   ...
   if(me->query_temp("search_song_food"))
        {
        message_vision(CYN "宋甜儿向你做了一个鬼脸：仲唔快点帮我去稳材料？ 。。。\n"NOR,me);
                return 1;
        } 
...
int accept_object(object me, object ob)
{
        ...
        for(i=0;i<7;i++)
        {
                if(ob_name==material_names[i])
                {
                        ...
                        message_vision("宋甜儿宛然一笑，说道：“多谢呢位"+RANK_D->query_respect(me)+"稳左"+ob_name+"俾我。”\n",me);
                        food_ok=1;
                }
