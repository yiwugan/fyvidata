...
string *first_name = ({ "赵","钱","孙","李","周","吴","郑","王","张","陈",
	"刘","林" });
string *name_words = ({ "顺","昌","寻","发","财","俊","彦","良","志","忠",
...
case 2: command("new " + rnd_say[random(sizeof(rnd_say))]); break;
...
case 7: command("new " + rnd_say[random(sizeof(rnd_say))]); break;
...
case 15: command("new " + rnd_say[random(sizeof(rnd_say))]); break;
case 16: command("new " + rnd_say[random(sizeof(rnd_say))]); break;
case 17: command("new " + rnd_say[random(sizeof(rnd_say))]); break;
			default:
				break;
		}
	}
