...
//#pragma optimize
#define LOWER_LIMIT 200000   //加大点，防止超出溢出 by xiaolang
#include <ansi.h>
#include <skill.h>
#include <weapon.h>
#include <combat.h> 
...
//  write(" damage is "+(string)(damage)+". \n"); 
        switch( type ) {
                case "拉伤":
                case "割伤":
                        if( damage < 100 ) return "结果只是轻轻地划破$n的皮肉。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 200 ) return "结果在$n的$l划出一道细长的血痕。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 400 ) return "结果「嗤」地一声划出一道伤口！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 800 ) return "结果「嗤」地一声划出一道血淋淋的伤口！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 1600 ) return "结果「嗤」地一声划出一道又长又深的伤口，溅得$N满脸鲜血！(" + damage + " 点" + type + ")。\n";
                        else return "结果只听见$n一声惨嚎，$n$l被划出一道深及见骨的可怕伤口！！(" + damage + " 点" + type + ")。\n";
                        break;
                case "刺伤":
                        if( damage < 100 ) return "结果只是轻轻地刺破$n的皮肉。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 200 ) return "结果在$n$l刺出一个创口。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 400 ) return "结果「噗」地一声刺入了$n$l寸许！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 800 ) return "结果「噗」地一声刺进$n的$l，使$p不由自主地退了几步！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 1600 ) return "结果「噗嗤」地一声，$n$l已被刺出一个血肉模糊的血窟窿！(" + damage + " 点" + type + ")。\n";
                        else return "结果只听见$n一声惨嚎，$n的$l被对穿而出，鲜血溅得满地！！(" + damage + " 点" + type + ")。\n";
                        break;
                case "瘀伤":
                        if( damage < 50 ) return  "结果只是轻轻地碰到，比拍苍蝇稍微重了点。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 100 ) return "结果在$n的$l造成一处瘀青。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 200 ) return "结果一击命中，$n的$l登时肿了一块老高！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 400 ) return "结果一击命中，$n闷哼了一声显然吃了不小的亏！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 800 ) return "结果「砰」地一声，$n退了两步！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 1200 ) return "结果这一下「砰」地一声打得$n连退了好几步，差一点摔倒！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 1600 ) return "结果重重地击中，$n「哇」地一声吐出一口鲜血！(" + damage + " 点" + type + ")。\n";
                        else return "结果只听见「砰」地一声巨响，$n像一捆稻草般飞了出去！！(" + damage + " 点" + type + ")。\n";
                        break;
                case "抓伤":
                        if( damage < 50 ) return "结果只是轻轻地抓到，比抓痒稍微重了点。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 100 ) return "结果在$n的$l抓出几条血痕。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 200 ) return "结果一抓命中，$n的$l被抓得鲜血飞溅！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 400 ) return "结果「嗤」地一声，$l被抓得深可见骨！！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 800 ) return "结果一抓命中，$n的$l被抓得血肉横飞！！！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 1200 ) return "结果这一下「嗤」地一声抓得$n连晃好几下，差一点摔倒！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 1600 ) return "结果$n哀号一声，$l被抓得筋断骨折！！(" + damage + " 点" + type + ")。\n";
                        else return "结果只听见$n一声惨嚎，$l被抓出五个血窟窿！鲜血溅得满地！！(" + damage + " 点" + type + ")。\n";
                        break;
           case "反弹伤":
                        if( damage < 10 ) return "$N受到$n$z的反震，闷哼一声。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 20 ) return  "$N被$n的$z震得气血翻腾，大惊失色。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 40 ) return "$N被$n的$z震得站立不稳，摇摇晃晃。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 80 ) return "$N被$n以$z反震，「嘿」地一声退了两步。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 160 ) return "$N被$n的$z反弹回来的力量震得半身发麻。(" + damage + " 点" + type + ")。\n";
                        else if( damage < 240 ) return "$N被$n的$z反弹力一震，胸口有如受到一记重击，连退了五六步！(" + damage + " 点" + type + ")。\n";
                        else if( damage < 320 ) return "$N被$n的$z一震，眼前一黑，身子向後飞出丈许！！(" + damage + " 点" + type + ")。\n";
                        else return "$N被$n的$z一震，眼前一黑，狂吐鲜血，身子象断了线的风筝向後飞去！！(" + damage + " 点" + type + ")。\n";
                        break;
                default:
                        if(!type) type = "伤害";
...
int skill_power(object ob, int usage) {
        ...
        if (level > 10000) level = 10000;    //add by xiaolang 防止溢出
     ...
     //     result = (result/100)*(status*100/ob->query("max_kee"));//最大误差1％，算是临时解决吧 by starfish 
     result = status*10/ob->query("max_kee")*result/10;
        }
}
else 
{
...
void auto_fight(object me, object obj, string type) {
        ...
        int silver1;
        if(!objectp(me) || !objectp(obj) || (!userp(me) && !userp(obj)) || me->is_fighting(obj) || me->query_temp("is_unconcious")
                ...
                if(fined) {
                        ...
                        if(objectp(room = find_object("/d/jinan/pyard"))
                                ...
                                if(cloth) {
                                        ...
                                        message_vision("$N顺手递给$n一个装满吃喝的篮子，就把$n押进了监狱。\n",me,obj);
                                }
...
void killer_reward(object killer, object victim) {
        ...
        if(userp(victim) ) {
                ...
                if((objectp(env)) && !(env->query("no_death_penalty")&& userp(killer)))
                        killer->add("PKS", 1);
                                       killer->add("OPK",1);
 ...
 /* if(killer->query("OPK") > 2)
            {          
                          objnew=new("d/wiz/luck/pker");
             objnew->move(environment(killer));
           objnew->set_leader(killer);
                    }  */
