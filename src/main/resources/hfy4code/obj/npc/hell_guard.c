...
void invocation(object who, int level)
{
        int i, bonus_skill;
        object *enemy,*pros; 
        set("str",50+level/6+random(level/8));
        set("agi",100+random(level/12));
        set("cor",150+random(level/12));
        
        set("max_kee",3000+random(level*level/6));
        ...
        set_skill("fork", 150 + level/4 + random(level/4));
        set_skill("parry", 150 + level/4 + random(level/4));
        set_skill("dodge", 150 + level/4 + random(level/4));
   set_skill("move", 50 + level/4 + random(level/4));
        set_skill("notracesnow",120 + level/4 + random(level/4));
        set_skill("hunting-fork",130 + level/4 + random(level/4));
