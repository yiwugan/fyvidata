...
/*
function initMissionNpcMap(){
	mapMissionNpc={};
	
	mapMissionNpc["吕迪"]="master lv";
	mapMissionNpc["杜桐轩"]="du tongxuan";
	mapMissionNpc["傅红雪"]="fu hongxue";
	mapMissionNpc["路小佳"]="lu xiaojia";
	mapMissionNpc["薛可可"]="xue keke";
	mapMissionNpc["燕南天"]="yan nantian";
	mapMissionNpc["岳刚"]="yue gang";
//	mapMissionNpc["唐无双"]="tang wushuang";
//	mapMissionNpc["俞放鹤"]="yu fanghe";
	mapMissionNpc["吴明"]="wu ming";

//autokill
//	mapMissionNpc["云真人"]="master yun";
	mapMissionNpc["小雷"]="lei";
//	mapMissionNpc["上官刃"]="shangguan ren";
	mapMissionNpc["花满楼"]="hua manlou";
	mapMissionNpc["宫九"]="gong jiu";
	mapMissionNpc["薛笑人"]="xue xiaoren";
	mapMissionNpc["薛衣人"]="xue yiren";
	mapMissionNpc["帅一凡"]="shuai yifan";
	mapMissionNpc["林还玉"]="lin huanyu";
	mapMissionNpc["李燕北"]="li yanbei";
	mapMissionNpc["唐傲"]="tang ao"; 
...
function writeMissionLog(log){
   ...
   fso = new ActiveXObject("Scripting.FileSystemObject")
   f = fso.OpenTextFile("c:\\mud\\fyvi\\mission.log", ForWriting, true)
   f.Write(new Date()+":"+log);
   f.Close();
}
