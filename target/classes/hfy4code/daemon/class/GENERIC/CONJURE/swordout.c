...
int conjure(object me, object target)
{
        ...
        if ((me->query_skill("sword",1)>400) && (me->query_skill("incarnation",1)>300))
        {
        	inv = all_inventory(me);
                ...
                sword->move(me);
                message_vision("$N低颂剑道心诀："+HIR"剑道乃至道，修剑必先修心。此身为剑，此剑为心！\n"NOR,me);
                message_vision(HIY"$N身上突然绽放出异芒，惊人的气劲往四面八方扩散出去......\n"NOR,me); 
                tell_object(me,"异芒散去，一把"+sword->name()+"出现在你手中，剑柄上传来的异感让你感觉到血肉般的联系.\n");
                return 1;
        }
