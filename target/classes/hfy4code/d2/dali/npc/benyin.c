...
void create()
{
        set_name("本因", ({ "master benyin", "master"}) );
...
大理天龙寺高僧。\n"
        ...
        set("chat_msg_combat", ({
                (: perform_action, "duan-yiyangzhi.shangyang" :)
        }) );
...
{
        if(me->query_temp("won_benchen") && ( me->query("gongxian") > 34560 ))
        {
        command("smile");
