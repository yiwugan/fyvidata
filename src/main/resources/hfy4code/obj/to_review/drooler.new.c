...
varargs void drool(string msg, string who)
{
   ...
   string *ob; 
        ...
        if( (strsrch(msg, "为什麽") >= 0) ) {
                ...
                switch(random(8)) {
                case 0: command("chat " + who + "，你是在问我吗？"); break;
                case 1: command("chat 关於" + msg + " ... "); break;
                case 2: command("chat 呃 ... "); drool(); break;
                case 3: command("chat 这个问题嘛 ...."); break;
                case 4: command("chat " + who + "，知道这个问题的答案对你那麽重要吗？"); break;
                case 5: command("chat " + msg + "？"); break;
                case 6: command("chat " + who + "你能不能说清楚一点？"); break;
                case 7: command("chat " + who + "，我不懂你问的问题"); break;
                }
        }
        ...
        ||      (strsrch(msg, "Drooler") >= 0)) {
                ...
                switch(random(10)) {
                case 0: command("chat " + who + "，你是说" + msg + "吗？");     break;
                case 1: command("chat 你确定" + msg + "？");    break;
                case 2: command("chat " + msg + "跟你有什麽关系？");    break;
                case 3: command("chat 嗯 ... " + who + "说得好"); break;
                case 4: command("chat " + who + "你为什麽对" + msg + "这麽有兴趣？"); break;
                case 5: command("chat 为什麽你认为" + msg + "？"); break;
                case 6: command("chat 换个话题吧"); drool(); break;
                case 7: command("chat 才怪"); break;
                case 8: command("chat 不一定吧？"); break;
                case 9: command("chat 有这个可能 ...."); break;
                }
   }
                ...
                case 2: command("chat 如果" + msg + "，我能帮你什麽忙吗？");    break;
                case 3: command("chat* hmm");   break;
                case 4: command("chat 你认为" + msg + "？"); break;
                case 5: command("chat 我有同感"); break;
                case 6: command("chat 你说的「" + msg + "」我不能苟同"); break;
                case 7: command("chat 有关「" + msg + "」的话题到此为止好吗？"); break;
                }
        } else {
                switch(random(20)) {
                        ...
                        case 3: command("chat* grin"); break;
                        case 4: command("chat* smile"); break;
                        case 5: command("chat* ?"); break;
                        case 6: command("chat ...."); break;
                        case 7: command("chat* hmm"); break;
