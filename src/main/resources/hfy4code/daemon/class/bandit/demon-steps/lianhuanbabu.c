...
int perform(object me, object target)
{
        ...
        if (( extra <= 100)&& me->query("bellicosity")< 200 && userp(me) ) return notify_fail("你的杀气不够高。需要二百杀气。\n");
      if ((extra > 100)&&(extra <= 160)&& me->query("bellicosity")< 300 && userp(me) ) return notify_fail("你的杀气不够高。需要三百杀气。\n");
