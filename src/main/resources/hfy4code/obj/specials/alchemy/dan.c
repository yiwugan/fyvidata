...
int do_use(string arg){
        ...
        if (to_cure == "all" ||to_cure == "gin") {
                if (eff_gin < gin - ((10-cure)*(gin-eff_gin))/200 ) {
                        eff_gin = gin - ((10-cure)*(gin-eff_gin))/200;
                }
        ...
        if (to_cure == "all" ||to_cure == "kee") {
                if (eff_kee < kee - ((10-cure)*(kee-eff_kee))/200 ) {
                        eff_kee = kee - ((10-cure)*(kee-eff_kee))/200;
                }
                me->set("eff_kee",eff_kee);
                me->set("kee",eff_kee);
        }
        if (to_cure == "all" ||to_cure == "sen") {
                if (eff_sen < sen - ((10-cure)*(sen-eff_sen))/200 ) {
                        eff_sen = sen - ((10-cure)*(sen-eff_sen))/200;
                } 
