...
int main(object me, string arg)
{
        ...
        if( me->query("combat_exp")<1000000 )
                return notify_fail("你现在这样的能力做这类事！\n");
        ...
        if( !arg || arg=="" ) {
                ...
                if( objectp(old_target) )
                        ...
                        write("你正守住 向" + default_dirs[old_target] + " 的方向，不准任何人离开。\n");
                return 1;
        }
        if( objectp(old_target) ) {
                ...
                if( living(old_target) )
                        write("你决定不再保护" + old_target->name() + "了。\n");
        ...
        else  return notify_fail("指令格式：guard <生物> | <物品> | <方向>\n");
